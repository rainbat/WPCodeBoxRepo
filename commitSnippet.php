...
add_shortcode( 'commit', function ( $atts = [], $content = null, $tag = '' ) {
	...
	$token = "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";
	...
	$content = '<?PHP echo date();';
	$ch = curl_init();
	
	$comitter = [
	        "name" => "Domi",
	        "email" => "into@rainbat.ch"
	];
	...
	$payload = [
	    ...
	    "content" => base64_encode( json_encode( "test2" ) )
	];
...
$html = <<<HTML
    <pre>$response_file_hash</pre>
    <pre>$response_file_content</pre>
HTML;
